                    ...
                    <div class="container-fluid px-4">
                        ...
                        while ($result = mysqli_fetch_array($query)) { ?>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <a href="edit-profile.php?uid=<?php echo $result['user_id']; ?>">Edit</a>
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Date of Birth</th>
                                            <td colspan="3"><?php echo $result['birthday']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Enrolment No.</th>
                                        ...
                                        <tr>
                                            <th>Course</th>
                                            <td colspan="3"><?php echo $result['course_name']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Faculty</th>
                                            <td colspan="3"><?php echo $result['faculty']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Interest</th>
                                            <td colspan="3"><?php echo $result['interest']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Contact No.</th>
                                            <td colspan="3"><?php echo $result['number']; ?></td>
                                        </tr>
