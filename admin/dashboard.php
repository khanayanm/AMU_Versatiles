                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <?php
                            $query1 = mysqli_query($conn, "select user_id from user where date(posting_date)=CURRENT_DATE()-1");
                            ...
                            <?php
                            $query2 = mysqli_query($conn, "select user_id from user where date(posting_date)>=now() - INTERVAL 7 day");
                            ...
                            <?php
                            $query3 = mysqli_query($conn, "select user_id from user where date(posting_date)>=now() - INTERVAL 30 day");
