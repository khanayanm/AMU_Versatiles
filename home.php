...
<body>
	...
	<nav id="navbar">
		...
		<ul>
			...
			<li class="item"><a href="home.php" title="Home"><label class="active">Home</label></a></li>
	...
	<div id="container">
		...
		$query = "SELECT * from post LEFT JOIN user on user.user_id = post.user_id order by post_id DESC";
		$result = mysqli_query($conn, $query);
		while ($row = mySQLi_fetch_array($result)) {
		...
		?>
			<div id="right-nav1">
				...
				$query = "SELECT * from comments where post_id='$post_id' order by post_id DESC";
				$result = mysqli_query($conn, $query);
				while ($row = mySQLi_fetch_array($result)) {
				...
				<form method="POST" action="comment.php">
					<div class="comment-area">
						...
						<?php $image = "select * from user where user_id='$id'";
